...
public class DB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
    	...
    	db.execSQL("CREATE TABLE " + DOCUMENTS_TABLE + "( FNSN TEXT, " + DOC_NO_FIELD
            + " INTEGER NOT NULL PRIMARY KEY," + DOC_DATE_FIELD + " INTEGER NOT NULL," + DOC_TYPE_FIELD
            + " INTEGER NOT NULL," + DOC_OFD_DATA_FIELD + " INTEGER ,"+ DOC_OISM_DATA_FIELD + " INTEGER);");
    ...
    public Cursor queryDocuments(String[] columns, String selection, String[] args, String order) {
        if (order == null) order = "DOCDATE desc";
