...
public class PrintSettings implements Parcelable {
     ...
     *
     * @return значения в точках левого и правого отступов
     */
     ...
     *
     * @return Размер шрифта по умолчанию
     */
     ...
     *
     * @param v размер шрифта по умолчанию
     */
     ...
     *
     * @return Наименование гарнитуры шрифта по умолчанию
     */
