...
public class JSONParser {
    ...
    public boolean parse(String json) throws JSONException {
        ...
        if(json != null && !json.isEmpty()) {
			...
			Log.d("LanterPOS","Reply : "+root.toString());
            if (checkRootFields(root)) {
    			Log.d("LanterPOS", "Parser type is "+mType);
    ...
    private boolean parseResponse(JSONObject objectField) throws JSONException{
    ...
    private void getFields(Set<ResponseFieldsList> fields, JSONObject objectField, Response responseObject) throws JSONException{
    ...
    private void getFieldSalesArray (JSONObject objectField, Response responseObject) throws JSONException{
        responseObject.setSalesArray(parseArray(ResponseFieldsList.SalesArray.getString(), objectField));
    }
    private void getFieldVoidArray(JSONObject objectField, Response responseObject) throws JSONException{
        responseObject.setVoidArray(parseArray(ResponseFieldsList.VoidArray.getString(), objectField));
    }
    private void getFieldRefundArray(JSONObject objectField, Response responseObject) throws JSONException{
    ...
    private Set<IResponse> parseArray(String arrayName, JSONObject objectField) throws JSONException {
